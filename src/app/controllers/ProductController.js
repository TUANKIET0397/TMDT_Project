...
class ProductController {
   ...
   // ...existing code...
    async index(req, res) {
        try {
            ...
            const categoriesMapped = categories.map(c => {
                ...
                const key = String(c).toLowerCase().replace(/\s+/g, '').replace(/[^a-z0-9-]/g, '');
            ...
            res.render('products/index', { products: [], count: 0, filters: {} });
        }
    }
    ...
    async knitwear(req, res) {
        try {
            const products = await Product.getProductsByType('Knitwear');
            res.render('products/knitwear', { products: products, count: products.length });
        } catch (error) {
            console.log(error);
            res.render('products/knitwear', { products: [], count: 0 });
        }
    }

    async outerwear(req, res) {
        try {
            const products = await Product.getProductsByType('Outerwear');
            res.render('products/outerwear', { products: products, count: products.length });
        } catch (error) {
            console.log(error);
            res.render('products/outerwear', { products: [], count: 0 });
        }
    }
    ...
    async pants(req, res) {
        try {
            ...
            res.render('products/pants', { products: products, count: products.length });
        } catch (error) {
            console.log(error);
    ...
    async shirts(req, res) {
        try {
            ...
            res.render('products/shirts', { products: products, count: products.length });
        } catch (error) {
            console.log(error);
    ...
    async shoes(req, res) {
        try {
            ...
            res.render('products/shoes', { products: products, count: products.length });
        } catch (error) {
            console.log(error);
    ...
    async sweatshirts(req, res) {
        try {
            const products = await Product.getProductsByType('Sweatshirts');
            res.render('products/sweatshirts', { products: products, count: products.length });
        } catch (error) {
            console.log(error);
            res.render('products/sweatshirts', { products: [], count: 0 });
        }
    }
    ...
    async tShirts(req, res) {
        try {
            ...
            res.render('products/t_shirts', { products: products, count: products.length });
        } catch (error) {
            console.log(error);
    ...
    async detail(req, res) {
        try {
            ...
            const relatedProducts = await Product.getRelatedProducts(product.TypeID, 4);
